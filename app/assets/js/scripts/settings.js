...
settingsNavDone.onclick = () => {
    try {
        ...
        console.error('Failed to save settings cleanly:', err)
    }
        ...
        if (Object.prototype.hasOwnProperty.call(queryMap, 'error')) {
            switchView(getCurrentView(), viewOnClose, 500, 500, () => {
                ...
                if (error === 'server_error') {
                    desc = '微軟伺服器回傳錯誤（server_error）。這通常代表啟動器尚未配置專屬的微軟 Azure Client ID，或尚未通過微軟官方 Minecraft 白名單審核。'
            ...
            AuthManager.addMicrosoftAccount(authCode).then(value => {
                ...
                .catch((displayableError) => {
                    ...
                    if(displayableError && displayableError.title && displayableError.desc) {
                        actualDisplayableError = displayableError
                    } else if(isDisplayableError(displayableError)) {
                        ...
                        actualDisplayableError = {
                            title: '微軟登入失敗',
                            desc: '處理微軟帳號驗證時發生錯誤，請稍後重試。'
                        }
                    }

                    const errorReturnView = viewOnClose === VIEWS.landing ? VIEWS.loginOptions : viewOnClose
                    switchView(getCurrentView(), errorReturnView, 500, 500, () => {
        ...
        el.innerHTML = `
            ...
            <div class="serverListingDetails">
                ...
                <div class="serverListingInfo">
                    ...
                    ${serv.rawServer.address ? `<div class="serverListingAddress" style="color: #38bdf8; font-size: 11px; font-weight: 700; background: rgba(56, 189, 248, 0.15); padding: 1px 8px; border-radius: 6px; border: 1px solid rgba(56, 189, 248, 0.3);">🌐 ${serv.rawServer.address}</div>` : ''}
